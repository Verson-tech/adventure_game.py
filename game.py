...
def cave(creature, tool, weapon):
    ...
    if 'sword' in weapon:
        ...
        print_pause(f'You discard your silly old '
                    f'{tool} and take the sword with you. ')
...
def house(creature, tool, weapon):
    ...
    print_pause('You are about to knock, when the '
                f'door opens and out steps a {creature}. ')
    ...
    if 'sword' in weapon:
        ...
        print_pause(f'The big sword shines brightly in your'
        ...
        print_pause(f'You feel a bit under-prepared for this,'
                    ' what with only having a tiny {tool}. ')
